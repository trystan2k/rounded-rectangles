...
NEXT STEPS:
  ...
  - Detect base branch: BASE_BRANCH=$(git merge-base --fork-point main || git merge-base --fork-point develop || echo "main")
  - Create PR targeting $BASE_BRANCH (MANDATORY: use template at docs/templates/pull-request.md)
```
</verification>
